...
class SoftMax(BaseLayer):
    ...
    def forward(self, input_tensor):
        ...
        tensor_sum = exp_tensor.sum(axis=exp_tensor.ndim-1, keepdims=True)   #sums up along axis 1,(i.e batch elements/columns) in the 2D array keeping other dimn. intact
